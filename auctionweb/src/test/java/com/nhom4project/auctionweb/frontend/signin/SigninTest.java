package com.nhom4project.auctionweb.frontend.signin;
...
/**
 * Unit tests for the Signin launcher view.
...
public class SigninTest {
    ...
    public void testStart() {
        ...
        try (MockedStatic<FXMLLoader> fxmlStatic = mockStatic(FXMLLoader.class);
            ...
            assertDoesNotThrow(() -> signin.start(mockStage));

            verify(mockStage).setTitle("Đăng nhập người dùng");
