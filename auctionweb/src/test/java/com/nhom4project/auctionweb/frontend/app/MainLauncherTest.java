...
/**
 * Unit tests for MainLauncher using Equivalence Partitioning (EP) and Boundary
 * Value Analysis (BVA).
 * Uses static mocking with Mockito to achieve full isolation from the native
 * JavaFX toolkit runtime.
 */
