...
public class AuthController {
    ...
    @PostMapping("/signin")
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody com.nhom4project.auctionweb.server.dto.SigninRequest signinRequest) {
        try {
            com.nhom4project.auctionweb.server.model.User user = userService.authenticate(signinRequest.getUsername(), signinRequest.getPassword());
