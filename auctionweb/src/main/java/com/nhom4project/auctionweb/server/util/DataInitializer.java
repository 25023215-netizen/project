package com.nhom4project.auctionweb.server.util;
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Seller account
        Seller seller = (Seller) userRepository.findByUsername("seller1");
        if (seller == null) {
            seller = new Seller();
        ...
        // Bidder accounts
        if (userRepository.findByUsername("bidder1") == null) {
        ...
        if (userRepository.findByUsername("bidder2") == null) {
        ...
        if (itemRepository.count() == 0 && auctionRepository.count() == 0) {
            ...
            a2.setEndTime(LocalDateTime.now().plusHours(1));
            ...
            a3.setEndTime(LocalDateTime.now().plusHours(2));
