...
import com.nhom4project.auctionweb.frontend.util.WebSocketClient;
...
public class AuctionDetailController {
                ...
                if (response.statusCode() == 200) {
                    ...
                    Platform.runLater(() -> {
                        ...
                        if (startingPrice != null) {
                            ...
                            addCustomSymbolAndLabel(lineData, value, tooltipText);
                        }
                        ...
                        for (int i = bids.size() - 1; i >= 0; i--) {
                            ...
                            addCustomSymbolAndLabel(lineData, amount, tooltipText);
                        }
    ...
    private void addCustomSymbolAndLabel(XYChart.Data<String, Number> data, double value, String tooltipText) {
        data.nodeProperty().addListener((obs, oldNode, newNode) -> {
            if (newNode != null) {
                if (newNode.getUserData() != null && "custom".equals(newNode.getUserData())) {
                    return;
                }
